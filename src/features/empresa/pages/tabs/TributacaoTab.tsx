...
export function TributacaoTab({ empresaId, empresa, onSave }: Props) {
  ...
  useEffect(() => {
    ...
    setForm((prev) => ({
      ...prev,
      regimeTributario: empresa.regimeTributario as EmpresaTributacaoFormData["regimeTributario"],
      rbt12: empresa.rbt12,
      anexoSimples: empresa.anexoSimples as EmpresaTributacaoFormData["anexoSimples"],
      percentualFatorR: empresa.percentualFatorR,
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-4">
        ...
        <div className="grid grid-cols-1 gap-4">
          <CnaePicker
            ...
            helperText="Busque pelo codigo (ex: 6201-5/01) ou descricao (ex: software)."
          />

          <CnaePickerMulti
            label="CNAEs secundarios (opcional)"
            ...
            helperText="Adicione CNAEs secundarios conforme necessario. Duplicados sao bloqueados."
